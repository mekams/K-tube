...
//  export { default as Navbar } from './Navbar';                                  //main----1
//  export { default as ChannelDetail } from './ChannelDetail';                   //split 7
//  export { default as Feed } from './Feed';                                   //sub-----2
...
//  export { default as Loader} from './Loader';                    //split------11